...
dir6<-here("s6") # Version 3.30.21
dir7<-here("s7") # Version 3.30.21
```
...
|    s7     | Flotas Espinel, Enmalle, Industrial y Capturas SMRPFO  |
...
SSplotTimeseries(base.model, subplot = 7)
```
...
SShcbias(retroSummary5,quant="F",verbose=F)
```
## Retro `s6`
...
retroModels7 <- SSgetoutput(dirvec=file.path(dir7, "Retrospective",
                                             paste("retro",0:-5,
                                                   sep="")))
